  ...
  "take_snapshot": {
    ...
    "args": {
      ...
      "role": {
        "name": "role",
        "type": "string",
        "description": "Filter elements by their accessibility role.",
        "required": false
      },
      "name": {
        "name": "name",
        "type": "string",
        "description": "Filter elements by their accessibility name (supports regular expressions).",
        "required": false
      },
      "text": {
        "name": "text",
        "type": "string",
        "description": "Filter elements by their text content (supports regular expressions).",
        "required": false
      }
    }
  },
