...
```sh
npx @modelcontextprotocol/inspector node "$PWD/build/src/bin/chrome-devtools-mcp.js"
```
...
```sh
npx @modelcontextprotocol/inspector node "$PWD/build/src/bin/chrome-devtools-mcp.js" --log-file=/your/desired/path/log.txt
```
