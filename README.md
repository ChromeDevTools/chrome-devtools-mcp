...
By default, the server runs with `--pageIdRouting` enabled, exposing `pageId` on
page-scoped tools so multiple agents or subagents sharing a server instance can
